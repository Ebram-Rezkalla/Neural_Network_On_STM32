...
STAI_ALIGNED(32) 
AI_ITCMRAM 
static uint8_t ITCMRAM[STAI_NETWORK_ACTIVATION_2_SIZE_BYTES];
STAI_ALIGNED(32) 
AI_RAM_D1 
static uint8_t RAM_D1[STAI_NETWORK_ACTIVATION_3_SIZE_BYTES];


/* Global c-array to handle the activations buffer */
stai_ptr data_activations[] = { DTCMRAM,ITCMRAM,RAM_D1 };
