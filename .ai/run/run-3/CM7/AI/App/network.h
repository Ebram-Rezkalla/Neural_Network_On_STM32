...
#define STAI_NETWORK_ORIGIN_MODEL_NAME         "mobilenet_rock_paper_scissors_int8"
#define STAI_NETWORK_ORIGIN_MODEL_SIGNATURE    "0x9bab4f2918ec644103bee84b1c013277"

/*  Generated model name and signature  */
#define STAI_NETWORK_MODEL_NAME                "network"
#define STAI_NETWORK_MODEL_SIGNATURE           (0xd0343229ff0e7595)
...
#define STAI_NETWORK_FLAGS               (STAI_FLAG_ACTIVATIONS|STAI_FLAG_STATES|STAI_FLAG_INPUTS|STAI_FLAG_OUTPUTS|STAI_FLAG_WEIGHTS)

/*  Macro to declare number of network C nodes generated  */
#define STAI_NETWORK_NODES_NUM           (85)

/*  Macro to declare number macc for generated network model  */
#define STAI_NETWORK_MACC_NUM            (19080889)

/*  Macros to declare input buffers characteristics  */
#define STAI_NETWORK_IN_NUM              (1)
#define STAI_NETWORK_IN_SIZE_BYTES       (16388)
...
#define STAI_NETWORK_IN_1_SHAPE       {1,128,128,1}
...
#define STAI_NETWORK_IN_1_SCALE       (0.9999597668647766f)
...
#define STAI_NETWORK_ACTIVATIONS_SIZE              (345940)
#define STAI_NETWORK_ACTIVATIONS_SIZE_BYTES        (345940)
#define STAI_NETWORK_ACTIVATIONS_ALIGNMENTS \
  { 4,4,4}
#define STAI_NETWORK_ACTIVATIONS_SIZES \
  { 71316,65536,209088}
#define STAI_NETWORK_ACTIVATIONS_NUM               (3)

#define STAI_NETWORK_ACTIVATION_1_FLAGS      (STAI_FLAG_ACTIVATIONS)
#define STAI_NETWORK_ACTIVATION_1_SIZE       (71316)
#define STAI_NETWORK_ACTIVATION_1_SIZE_BYTES (71316)
#define STAI_NETWORK_ACTIVATION_1_ALIGNMENT  4
#define STAI_NETWORK_ACTIVATION_2_FLAGS      (STAI_FLAG_ACTIVATIONS)
#define STAI_NETWORK_ACTIVATION_2_SIZE       (65536)
#define STAI_NETWORK_ACTIVATION_2_SIZE_BYTES (65536)
#define STAI_NETWORK_ACTIVATION_2_ALIGNMENT  4
#define STAI_NETWORK_ACTIVATION_3_FLAGS      (STAI_FLAG_ACTIVATIONS)
#define STAI_NETWORK_ACTIVATION_3_SIZE       (209088)
#define STAI_NETWORK_ACTIVATION_3_SIZE_BYTES (209088)
#define STAI_NETWORK_ACTIVATION_3_ALIGNMENT  4
/*  Macros to declare weights buffers characteristics  */

#define STAI_NETWORK_WEIGHTS_NUM                  (1)
#define STAI_NETWORK_WEIGHTS_SIZE                  (414076)
#define STAI_NETWORK_WEIGHTS_SIZE_BYTES            (414076)
...
#define STAI_NETWORK_WEIGHT_1_SIZE        (414076)
#define STAI_NETWORK_WEIGHT_1_SIZE_BYTES  (414076)
