...
/* -> activations_1 is allocated in NETWORK.c */
/* Array to store the data of the activation buffers */
/* -> activations_2 is allocated in NETWORK.c */
/* Array to store the data of the activation buffers */
/* -> activations_3 is allocated in NETWORK.c */
...
int aiInit(void)
{
  ...
  /* Activation buffers are allocated in the NETWORK.c */
